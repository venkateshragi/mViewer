                ...
                on: {
                    success: function (ioId, responseObject) {
                        ...
                        if (response !== undefined) {
                            ...
                            Y.one("#logMessage").set("innerHTML", response + "<br> Please send us mViewer.log stored in the logs directory of the application server in case of any problems.<br> aditya.g@imaginea.com , rachit.m@imaginea.com");
                        } else {
