...
public class CollectionServiceImpl implements CollectionService {
     ...
     * 
     */
    public Set<String> getCollList(String dbName) throws ValidationException,
            DatabaseException, CollectionException {
    ...
    public String insertCollection(String dbName, String collectionName,
            boolean capped, int size, int maxDocs) throws DatabaseException,
        ...
        try {
            ...
            if (mongoInstance.getDB(dbName).getCollectionNames()
                ...
                throw new DuplicateCollectionException("Collection ["
                        + collectionName + "] Already exists in Database ["
                        + dbName + "]");
            }
