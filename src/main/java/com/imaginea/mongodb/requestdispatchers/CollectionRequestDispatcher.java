...
/**
 * Defines resources for performing create/drop operations on collections present inside databases in Mongo we are
 * currently connected to. Also provide resources to get list of all collections in a database present in mongo and also
 * statistics of a particular collection.
 * <p>
 ...
 * GET and POST request resources for collections are defined here. For PUT and DELETE functionality , a POST request
 * with an action parameter taking values PUT and DELETE is made.
 * 
...
public class CollectionRequestDispatcher extends BaseRequestDispatcher {
    ...
    /**
     * Maps GET Request to get list of collections inside databases present in mongo db to a service function that
    ...
    /**
     * Maps POST Request to perform create/drop on collections inside databases present in mongo db to a service
     ...
     * @param collectionName Name of Database for which to perform create/drop operation depending on action patameter
    ...
    @Path("/{collectionName}")
    @Produces(MediaType.APPLICATION_JSON)
    public String postCollRequest(@PathParam("dbName") String dbName, @PathParam("collectionName") String collectionName, @FormParam("isCapped") String capped,
            @QueryParam("collSize") int size, @QueryParam("collMaxSize") int maxDocs, @QueryParam("action") String action, @QueryParam("tokenId") String tokenId,
